...
class FirstViewController: UIViewController {
    ...
    let movieLoadButton: UIButton = {
        let movieLoadButton = UIButton()
        movieLoadButton.setTitle("Load first movie", for: .normal)
...
////        playerVC.onView = view
//
//        UIApplication.shared.keyWindow?.addSubview(playerVC.view)
...
//
        ...
        UIView.animate(withDuration: 0.5, animations: {
            ...
            playerVC.view.frame = CGRect(x: 0, y: 0, width: UIApplication.shared.keyWindow!.bounds.width, height: UIApplication.shared.keyWindow!.bounds.height)
